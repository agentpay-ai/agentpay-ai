      ...
      <div className="w-full max-w-sm bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl space-y-5 relative">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Powered by BotChain Network & Multi-Chain Facilitator</p>
          </div>
        </div>
        ...
        <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 space-y-2">
          ...
          <div className="flex justify-between text-xs text-slate-400">
            ...
            <span className="font-medium text-purple-400">BotChain EVM</span>
          </div>
        ...
        <div className="flex items-center space-x-2 text-xs text-slate-400 bg-slate-800/50 p-3 rounded-lg border border-slate-800">
          ...
          <span>EIP-712 / EIP-3009 transfer authorization signed on BotChain EVM.</span>
        </div>
